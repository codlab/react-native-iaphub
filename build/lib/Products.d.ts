...
export declare type IapHubSubscriptionState = 'active' | 'grace_period' | 'retry_period' | 'paused' | 'expired';
export declare type IapHubProductTypes = 'consumable' | 'non_consumable' | 'subscription' | 'renewable_subscription';
/***
 * PER_1_WEEK = 'P1W',
 * PER_1_MONTH = 'P1M',
 * PER_3_MONTHS = 'P3M',
 ...
 * PER_1_YEAR = 'P1Y'
 **/
export declare type IapHubSubscriptionPeriod = 'P1W' | 'P1M' | 'P3M' | 'P6M' | 'P1Y';
export declare type IapHubSubscriptionPeriodType = 'normal' | 'trial' | 'intro';
export declare type IapHubIntroductoryPaymentType = 'as_you_go' | 'upfront' | 'free_trial';
export declare type IapHubWebhookStatus = 'failed' | 'success';
