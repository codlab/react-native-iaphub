...
var Iaphub = /** @class */ (function () {
    ...
    Iaphub.prototype.buy = function (sku, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var product, crossPlatformConflict, prorationModes, prorationModes, buyPromise, activeSubscription, err_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (!product) {
                            product = this.user.activeProducts.find(function (product) { return product.sku == sku; });
                        }
                        ...
                        if (typeof opts.androidProrationMode != 'undefined') {
                            prorationModes = { 1: 'immediate_with_time_proration', 2: 'immediate_and_charge_prorated_price', 3: 'immediate_without_proration', 4: 'deferred' };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        subscriptions = this.user.activeProducts.filter(function (item) { return item.type == 'renewable_subscription'; });
    ...
    Iaphub.prototype.fetchUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var promise, data, products, productIds, subscriptionIds, productsInfos, _a, _b, err_5, convertToISO8601, formatProduct, oldUser, err_6, err_7;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.setPricing([].concat(this.user.productsForSale).concat(this.user.activeProducts))];
                    case 11:
                        _c.sent();
                        return [3 /*break*/, 13];
                    case 12:
                    ...
                    case 13:
                        // Resolve promises
                        this.userFetchPromises.forEach(function (promise) { return promise.resolve(_this.user); });
                        return [3 /*break*/, 15];
                    case 14:
                        err_7 = _c.sent();
    ...
    Iaphub.prototype.setPricing = function (products) {
        return __awaiter(this, void 0, void 0, function () {
            var productsPricing, sameProducts;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.productsPricing) {
                            sameProducts = productsPricing.filter(function (productPricing) {
                                return _this.productsPricing.find(function (item) {
    ...
    Iaphub.prototype.processReceipt = function (opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var receipt, newTransactions, oldTransactions, shouldFinishReceipt, productType, error, response, err_11, newTransactionsOverride, err_12, transaction, request, oldTransaction, product, err_13;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        receipt = {
                    ...
                    case 12:
                        ...
                        if (this.buyRequest) {
                            ...
                            // Otherwise resolve with the transaction
                                ...
                                product = this.user.productsForSale.find(function (product) { return product.sku == transaction.sku; });
    ...
    Iaphub.prototype.finishReceipt = function (purchase, productType) {
        return __awaiter(this, void 0, void 0, function () {
            var shouldBeConsumed, shouldBeConsumed, err_15;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.userId)
                            throw "user_id_empty";
                        // Default params
                        params = __assign(__assign({}, params), { platform: this.platform, environment: this.environment, libraryName: 'react_native', libraryVersion: this.version });
                        // Handle get request
                        if (type == "get") {
                            query = "";
                            for (param in params) {
     ...
     */
    Iaphub.prototype.emitReceiptProcessed = function () {
        var params = [];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.onReceiptProcessed.apply(this, params)];
                    case 2:
